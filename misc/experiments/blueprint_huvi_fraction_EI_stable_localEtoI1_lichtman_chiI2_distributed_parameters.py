...
net_params = {
    'outpath': '/p/scratch/cjinb33/shimoura1/huvi_fraction_EI_stable_localEtoI1_lichtman_chiI2_distributed_parameters',
...
tau_syn_in = 2.
g = -5.
CC_SCALING = [1., 1.25, 1.5, 1.75, 2., 2.25, 2.5, 2.75, 3., 4.0]
